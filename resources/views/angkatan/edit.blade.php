        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="post" action="{{ route('angkatan.update', $angkatan->id)}}" class="form-horizontal">
                        ...
                        <div class="form-group{{ $errors->has('angkatan') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="angkatan" value="{{ $angkatan->angkatan }}">
